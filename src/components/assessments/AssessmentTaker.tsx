...
import { Clock, AlertTriangle, CheckCircle2, ArrowLeft, ArrowRight, Flag, Send } from "lucide-react";
...
interface Question {
  ...
  correctAnswer?: string; // Only used for checking answers
}
...
const AssessmentTaker: React.FC<AssessmentTakerProps> = ({
  ...
  const [remainingTime, setRemainingTime] = useState(timeLimit * 60); // convert to seconds
  ...
  const calculateScore = () => {
    ...
    // Only for demo purposes - in a real app the scoring would happen on the backend
  ...
  const lowTimeWarning = remainingTime < 300; // less than 5 minutes
        ...
        <CardContent className="space-y-6">
          {lowTimeWarning && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                You have less than 5 minutes remaining to complete this assessment.
              </AlertDescription>
            </Alert>
          )}
